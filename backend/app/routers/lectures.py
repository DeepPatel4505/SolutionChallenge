...
async def upload_lecture(
    ...
    storage_path = f"{current_user['user_id']}/{lecture_id}.{file_ext or 'upload'}"
    ...
    background_tasks.add_task(_process_lecture, lecture_id, audio_url, content_type, file_ext)
